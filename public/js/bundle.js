...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFodmEiLCJhIjoiY21jbmg1YnhxMDdpZDJqb2x2bzdneWh1aSJ9.kmSuxTCVvUHlqHgoe5lf6g';
...
var stripe = Stripe('pk_test_51RkrXBHCK3eBVf7HnmvJMyZZ3CQO8dJmyfzw6T4fNYA6cmBUqhFi9O8dStf45It2eP9rF85KxJA0o0x09sFhNwUj00K6dY2t6J');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 3:
          ...
          _t = _context.v;
          console.log(_t);
          (0, _alert.showAlert)('error', _t.response?.data?.message || _t.message);
